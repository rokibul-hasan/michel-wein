    	...
    	<div id="tab1" class="tab_content">
    		...
    		<table width="100%" border="0" cellspacing="4" cellpadding="4">
    			...
    			<tr class="even">
    				...
    				<td>1 l</td>
    				<td>5,80 €</td>
    				<td><input name="winzerschoppe" type="text" value="1" class="bestellung" maxlength="3" /></td>
    				</tr>
    			<tr class="odd">
    				<td>2</td>
    				<td>Michel Angelo</td>
    				<td>0,75 l</td>
    				<td>5,80 €</td>
    				<td><input name="michelangelo" type="text" value="1" class="bestellung" maxlength="3" /></td>
    				</tr>
    			</table>
    		<h2>&nbsp;</h2>
    		</div>
